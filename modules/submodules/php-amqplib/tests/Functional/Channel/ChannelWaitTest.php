...
class ChannelWaitTest extends TestCase
{
     ...
     */
    public
            function should_wait_until_signal_by_default($factory)
    {
     ...
     */
    public
            function should_throw_timeout_exception($factory)
    {
        $channel = $factory();
    ...
    protected
            function channelFactory($stream = true, $connectionTimeout = 1, $heartBeat = 0)
    {
    ...
    protected
            function closeChannel(AMQPChannel $channel)
    {
