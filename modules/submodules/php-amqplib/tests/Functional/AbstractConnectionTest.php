        ...
        class AbstractConnectionTest extends TestCase
{
    ...
    protected
            function queue_bind(AMQPChannel $channel, $exchange_name, &$queue_name)
    {
     ...
     */
    protected
            function create_proxy($name = 'amqp_connection')
    {
    ...
    protected
            function get_toxiproxy_amqp_port()
    {
    ...
    protected
            function assertConnectionClosed(AbstractConnection $connection)
    {
    ...
    protected
            function assertChannelClosed(AbstractChannel $channel)
    {
