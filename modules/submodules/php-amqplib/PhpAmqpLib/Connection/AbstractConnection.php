        ...
        class AbstractConnection extends AbstractChannel
{
     ...
     */
    private
            $prepare_content_cache = array();

    /** @var int Maximal size of $prepare_content_cache */
    private
            $prepare_content_cache_max_size = 100;
     ...
     */
    public
            function set_close_on_destruct($close = true)
    {
     ...
     */
    public
            function send_content($channel, $class_id, $weight, $body_size, $packed_properties, $body, $pkt)
    {
     ...
     */
    public
            function prepare_content($channel, $class_id, $weight, $body_size, $packed_properties, $body, $pkt)
    {
     ...
     */
    protected
            function send_channel_method_frame($channel, $method_sig, $args = '', $pkt = null)
    {
     ...
     */
    protected
            function prepare_channel_method_frame($channel, $method_sig, $args = '', $pkt = null)
    {
     ...
     */
    protected
            function wait_channel($channel_id, $timeout = 0)
    {
     ...
     */
    protected
            function x_open($virtual_host, $capabilities = '', $insist = false)
    {
        $args = new AMQPWriter();
     ...
     */
    protected
            function connection_open_ok($args)
    {
     ...
     */
    protected
            function connection_secure($args)
    {
        $args->read_longstr();
    }
     ...
     */
    protected
            function x_start_ok($clientProperties, $mechanism, $response, $locale)
    {
        $args = new AMQPWriter();
     ...
     */
    protected
            function connection_blocked(AMQPReader $args)
    {
        $this->blocked = true;
     ...
     */
    public
            function set_connection_block_handler($callback)
    {
     ...
     */
    public
            function set_connection_unblock_handler($callback)
    {
        Assert::isCallable($callback);
     ...
     */
    public static
            function create_connection($hosts, $options = array())
    {
