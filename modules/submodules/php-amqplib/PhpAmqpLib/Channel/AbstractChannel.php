        ...
        class AbstractChannel
{
     ...
     */
    const
            PROTOCOL_080 = Wire\Constants080::VERSION;
     ...
     */
    public
            function setBodySizeLimit($max_bytes)
    {
     ...
     */
    public
            function dispatch($method_sig, $args, $amqpMessage)
    {
     ...
     */
    protected
            function send_method_frame($method_sig, $args = '')
    {
     ...
     */
    protected
            function prepare_method_frame($method_sig, $args = '', $pkt = null)
    {
     ...
     */
    public
            function wait($allowed_methods = null, $non_blocking = false, $timeout = 0)
    {
     ...
     */
    protected
            function dispatch_deferred_method($queued_method)
    {
     ...
     */
    protected
            function validate_method_frame($frame_type)
    {
     ...
     */
    protected
            function validate_header_frame($frame_type)
    {
     ...
     */
    protected
            function validate_body_frame($frame_type)
    {
     ...
     */
    protected
            function validate_frame($frameType, $expectedType, $expectedMessage)
    {
     ...
     */
    protected
            function validate_frame_payload($payload)
    {
     ...
     */
    protected
            function build_method_signature($payload)
    {
     ...
     */
    protected
            function should_dispatch_method($allowed_methods, $method_sig)
    {
        return $allowed_methods == null || in_array($method_sig, $allowed_methods) || $this->constants->isCloseMethod($method_sig);
    }
     ...
     */
    protected
            function maybe_wait_for_content($method_sig)
    {
        $amqpMessage = null;
