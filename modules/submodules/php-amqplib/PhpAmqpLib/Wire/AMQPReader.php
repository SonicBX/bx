...
class AMQPReader extends AbstractClient
{
     ...
     */
    public
            function __construct($str, AbstractIO $io = null, $timeout = 0)
    {
        parent::__construct();
     ...
     */
    public
            function read_table($returnObject = false)
    {
        $this->resetCounters();
     ...
     */
    public
            function read_array($returnObject = false)
    {
        $this->resetCounters();
     ...
     */
    public
            function read_value($fieldType, $collectionsAsObjects = false)
    {
        $this->resetCounters();
