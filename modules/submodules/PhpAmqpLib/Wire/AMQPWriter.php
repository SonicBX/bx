...
class AMQPWriter extends AbstractClient
{
     ...
     */
    public
            function write_signed_longlong($n)
    {
        if (is_int($n))
        {
            if ($this->is64bits)
