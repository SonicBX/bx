<?php //bx/modules/sql.bx.php

$bx["sql"]["read_connection"] = array();
$bx["sql"]["write_connection"] = array();

function bxsql_fetch($bxsql_result) { return(mysqli_fetch_assoc($bxsql_result)); }

function bxsql_num_rows($bxsql_result) { return(mysqli_num_rows($bxsql_result)); }
